...
html_static_path = ['../common/_static', 'media']
...
htmlhelp_basename = 'sitecore-helix'
...
latex_documents = [
  ('index', 'sitecore-helix.tex', 'Sitecore Helix Documentation',
   'Sitecore', 'manual'),
]
...
man_pages = [
    ('index', 'sitecore-helix', 'Sitecore Helix Documentation',
     ['Sitecore'], 1)
]
...
texinfo_documents = [
  ('index', 'sitecore-helix', 'Sitecore Helix Documentation',
   'Sitecore', 'sitecore-helix', 'Sitecore Helix Documentation',
   'Configuration'),
]
