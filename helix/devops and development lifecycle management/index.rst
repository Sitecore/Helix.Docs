...
-  **Build** – or *Integration* in which the implementation is put
   together as a single testable package

-  **Testing** – in which the features or integrated package are tested
   against the specifications

-  **Deployment** – in which the package is ultimately deployed onto the
